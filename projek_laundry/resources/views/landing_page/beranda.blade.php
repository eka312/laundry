...
<head>
    ...
    <title> Beranda | Selsil Laundry</title>
...
<body>
		                ...
		                <div class="mt-4 pt-2">
		                    <div class="text-center text-xl-start">
		                        <h1 class="m-0 text-white tracking-tight text-6xl fw-bold" data-aos-delay="0" data-aos="fade" data-aos-duration="3000">
		                            Rasakan Kebersihan Terbaik
		                        </h1>
		                        <p class="m-0 mt-4 text-white text-lg leading-8" data-aos-delay="100" data-aos="fade" data-aos-duration="3000">
		                            Tak perlu khawatir lagi soal cucian! Biarkan kru profesional kami di Selsil Laundry Service mengerjakan tugas Anda.
		                        </p>
		                        <div class="mt-4 pt-3 d-flex align-items-center justify-content-center justify-content-xl-start column-gap-3">
		                            <a href="/kontak" class="btn btn-lg btn-primary text-white text-sm fw-semibold" data-aos-delay="200" data-aos="fade" data-aos-duration="3000">
		                                Hubungi Kami
		                            </a>
	...
	<div class="overflow-hidden py-7 py-sm-8 py-xl-9 bg-body-tertiary">
	    <div class="container">
	        <div>
	            <div class="mx-auto max-w-2xl text-center">
	                ...
	                <p class="m-0 mt-2 text-body-emphasis text-4xl tracking-tight fw-bold">
	                    Layanan Binatu yang Nyaman di Blitar
	                </p>
	            ...
	            <div class="row row-cols-1 row-cols-xl-3 gy-5 gx-xl-4 mt-1 justify-content-center justify-content-xl-between">
	                <div class="col pt-5 pt-xl-4">
	                    <div class="max-w-xl mx-auto mx-xl-0" data-aos-delay="0" data-aos="fade" data-aos-duration="1000">
                        	<div class="ratio" style="--bs-aspect-ratio: 66.66%;">
                                <img src=" Freshen-1.0.0/assets/img/bg/bg2.jpg" class="object-fit-cover rounded-3" alt="Service image" loading="lazy">
                            </div>

                            <h3 class="m-0 mt-4 text-body-emphasis text-lg leading-6 fw-semibold">
                                Pencucian Kering Ramah Lingkungan
                            </h3>
                            ...
                            <p class="m-0 mt-3 text-body-secondary line-clamp-2 text-sm leading-6">
                                Bersihkan pakaian halus Anda dengan aman dengan layanan dry cleaning ramah lingkungan kami
                            </p>
	                    </div>
	                </div>
      				...
      				<div class="col pt-5 pt-xl-4">
	                    <div class="max-w-xl mx-auto mx-xl-0" data-aos-delay="100" data-aos="fade" data-aos-duration="1000">
                        	<div class="ratio" style="--bs-aspect-ratio: 66.66%;">
                                <img src=" Freshen-1.0.0/assets/img/bg/bg3.jpg" class="object-fit-cover rounded-3" alt="Service image" loading="lazy">
                            </div>
                            ...
                            <!-- Remove line-clamp-2 if you need more lines or add line-clamp-3 -->
                            <p class="m-0 mt-3 text-body-secondary line-clamp-2 text-sm leading-6">
							Hemat waktu dengan membiarkan kami menangani kebutuhan laundry Anda melalui layanan cuci & lipat kami yang efisien, memastikan pakaian Anda bersih dan terlipat rapi.
                            </p>
	                    </div>
	                </div>
	                ...
	                <div class="col pt-5 pt-xl-4">
	                    <div class="max-w-xl mx-auto mx-xl-0" data-aos-delay="200" data-aos="fade" data-aos-duration="1000">
                        	<div class="ratio" style="--bs-aspect-ratio: 66.66%;">
                                <img src=" Freshen-1.0.0/assets/img/bg/bg4.jpg" class="object-fit-cover rounded-3" alt="Service image" loading="lazy">
                            </div>
                            ...
                            <!-- Remove line-clamp-2 if you need more lines or add line-clamp-3 -->
                            <p class="m-0 mt-3 text-body-secondary line-clamp-2 text-sm leading-6">
                                Datang pagi, ambil sore! Layanan cuci kilat kami siap membuat pakaian Anda bersih dan siap pakai hanya dalam beberapa jam.
                            </p>
	                    </div>
	                </div>
	            </div>
	        ...
	        <div class="text-center pt-7">
	            <a href="/layanan" class="btn btn-lg btn-primary text-white icon-link icon-link-hover text-sm leading-6 fw-semibold">
                    selengkapnya
	...
	<div class="overflow-hidden py-7 py-sm-8 py-xl-9 text-capitalize">
		<div class="container">
			<div class="row gy-5 align-items-center justify-content-between">
				<div class="col-12 col-xl-5 order-last">
					<div class="mx-auto max-w-2xl">
						...
						<p class="m-0 mt-2 text-body-emphasis text-4xl tracking-tight fw-bold">
							Membuat urusan laundry jadi mudah, satu pakaian bersih dalam satu waktu.
						</p>
						<p class="m-0 mt-4 text-body-secondary text-lg leading-8">
							Selamat datang di Selsil, layanan laundry unggulan Anda di Blitar, Kami berkomitmen untuk memberikan solusi laundry yang berkualitas tinggi, praktis, dan terjangkau bagi pelanggan kami yang terhormat.
						</p>
						<div class="mt-4">
							<a href="/tentang_kami" class="icon-link icon-link-hover text-decoration-none text-sm leading-6 fw-bold">
			                    Selengkapnya 
			                    <span class="bi align-self-start left-to-right" aria-hidden="true">→</span>
			                    <span class="bi align-self-start right-to-left" aria-hidden="true">←</span>
			                </a>
				...
				<div class="col-12 col-xl-6">
					<div class="mx-auto max-w-2xl">
                        <div class="ratio ratio-4x3" data-aos-delay="0" data-aos="fade" data-aos-duration="3000">
                            <img src=" Freshen-1.0.0/assets/img/bg/bg5.jpg" class="object-fit-cover rounded-3" alt="about us" loading="lazy">
                        </div>
					</div>
				</div>
			</div>
		    ...
		    <div class="ratio ratio-16x9 mt-7 mt-sm-8 mt-xl-9">
                <img src=" Freshen-1.0.0/assets/img/bg/bg6.jpg" class="object-fit-cover rounded-3" alt="presentation" loading="lazy">
            </div>
		</div>
	</div>
    ...
    <script src=" Freshen-1.0.0/assets/php/contact/script.js"></script>
