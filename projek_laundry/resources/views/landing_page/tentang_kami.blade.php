...
<head>
    ...
    <title>Tentang Kami | Sesil Laundry</title>
...
<body>
		    ...
		    <div class="container h-100 d-flex align-items-center">
                <div class="max-w-2xl mx-auto mx-xl-0 text-center text-xl-start">
                    ...
                    <p class="m-0 mt-4 text-white text-lg leading-8" data-aos-delay="100" data-aos="fade" data-aos-duration="3000">
                        Membuat cucian menjadi mudah, satu pakaian bersih dalam satu waktu.
                    </p>
                </div>
		    </div>
	    </div>
			...
			<div class="row gy-5 align-items-center justify-content-between">
				<div class="col-12 col-xl-5 order-first order-xl-last">
					<div class="mx-auto max-w-2xl">
						...
						<p> Membuat cucian menjadi tanpa usaha, satu lipatan bersih dalam satu waktu. </p>
                        <p>
                            Selamat datang di Freshen, layanan laundry utama Anda di New York, NY. Kami berdedikasi untuk menyediakan solusi laundry yang berkualitas tinggi, praktis, dan terjangkau bagi pelanggan kami yang berharga.
                        </p>
                        <p>
                            Dengan fasilitas berteknologi tinggi dan staf ahli kami, kami memastikan bahwa pakaian Anda diperlakukan dengan perhatian dan perawatan terbaik. Percayakan kebutuhan laundry Anda kepada Freshen dan rasakan perbedaannya hari ini.
                        </p>
					</div>
				</div>
				...
				<div class="col-12 col-xl-6">
					<div class="mx-auto max-w-2xl">
                        <div class="ratio ratio-4x3" data-aos-delay="200" data-aos="fade" data-aos-duration="3000">
                            <img src="Freshen-1.0.0/assets/img/bg/bg5.jpg" class="object-fit-cover rounded-3" alt="presentation">
                        </div>
					</div>
				</div>
			</div>		
	...
	<div class="overflow-hidden py-6 py-sm-7 py-xl-8 text-capitalize">
		<div class="container">
			<div class="row gy-5 row-cols-1 row-cols-lg-3">
				<div class="col" data-aos-delay="0" data-aos="fade-left" data-aos-duration="3000">
					...
					<p class="m-0 mt-2 text-body-secondary text-base leading-7 max-w-lg">
                        Untuk membebaskan Anda dari pekerjaan rumah mencuci pakaian. Kami percaya waktu Anda berharga dan seharusnya digunakan untuk hal-hal yang Anda sukai. Kami menawarkan layanan laundry yang nyaman dan dapat diandalkan yang membebaskan Anda dari tugas mencuci, mengeringkan, dan melipat pakaian yang membosankan.
					</p>
				</div>
				...
				<div class="col" data-aos-delay="100" data-aos="fade-left" data-aos-duration="3000">
					...
					<p class="m-0 mt-2 text-body-secondary text-base leading-7 max-w-lg">
                        Kami membayangkan masa depan di mana semua orang dapat menikmati waktu luang tanpa khawatir tentang cucian. Dengan berinvestasi dalam teknologi, keberlanjutan, dan kepuasan pelanggan, kami ingin membentuk masa depan laundry yang lebih baik dan lebih hijau. 
					</p>
				</div>
				...
				<div class="col" data-aos-delay="200" data-aos="fade-left" data-aos-duration="3000">
					...
					<p class="m-0 mt-2 text-body-secondary text-base leading-7 max-w-lg">
                        Kami menjunjung tinggi nilai integritas, keandalan, dan pelayanan pelanggan. 
                        Kami percaya bahwa kepercayaan dibangun melalui konsistensi dan kualitas layanan,
                        dan kami berkomitmen untuk memberikan yang terbaik setiap saat. 
					</p>
				</div>
			</div>
		</div>
 	...
 	<!-- 2 landscap images -->
 	<div class="overflow-hidden pt-6 pt-sm-7 pt-xl-8 pb-7 pb-sm-8 pb-xl-9 text-capitalize">
		<div class="container">
                ...
                <div class="col-12 col-xl-6 col-xxl-5">
                    <div class="mx-auto mx-xl-0 max-w-2xl">
                        ...
                        <p class="m-0 mt-2 text-body-emphasis text-4xl tracking-tight fw-bold">
                            Dari Masalah Laundry Menjadi Awal yang Segar
                        </p>
                        <p class="m-0 mt-4 text-body text-lg leading-8">
                            Semuanya berawal dari pengamatan sederhana: laundry. Ini adalah siklus yang tak pernah berakhir, mencuri waktu berharga dan sering kali membuat kita merasa kewalahan. Kami, para pendiri [Nama Layanan Laundry Anda], tidak asing dengan tumpukan cucian yang tumbuh lebih cepat dari kemampuan kami melipatnya.
                        </p>
                        <p class="m-0 mt-4 text-body text-lg leading-8">
                            Tapi cerita kami belum berakhir! Kami terus mencari cara untuk meningkatkan dan memperluas layanan kami, selalu berusaha membuat kegiatan mencuci menjadi lebih mudah bagi Anda. 
                            Bergabunglah dalam perjalanan kami menuju hari esok yang lebih segar dan bersih!
                        </p>
                    </div>
                </div>
                <div class="col-12 col-xl-6">
                    <div class="mx-auto mx-xl-0 max-w-2xl">
                        <div class="ratio ratio-4x3" data-aos-delay="0" data-aos="fade" data-aos-duration="3000">
                            <img src="Freshen-1.0.0/assets/img/bg/bg2.jpg" class="object-fit-cover rounded-3" alt="presentasi" loading="lazy">
                        </div>
                    </div>
                </div>
            </div>
	...
	<div class="overflow-hidden py-6 py-sm-7 py-xl-8">
		<div class="container">
            <div class="ratio ratio-16x9">
                <img src="Freshen-1.0.0/assets/img/bg/bg8.jpg" class="object-fit-cover rounded-3" alt="presentation" loading="lazy">
            </div>
		</div>
	</div>
    ...
    <div class="pb-9 pt-7">
        <div class="container">
            <div class="py-6 position-relative text-white rounded-3">
                <img src="Freshen-1.0.0/assets/img/bg/bg10.jpg" class="position-absolute z-n1 top-0 h-100 w-100 object-fit-cover rounded-3" loading="lazy" alt="Pertemuan">
                ...
                <div class="px-6">
                    <div class="mx-auto max-w-2xl">
                        ...
                        <p class="m-0 mt-4 text-lg leading-8 text-center">
                            Biarkan kami yang mengurus cucianmu, agar kamu bisa fokus pada hal-hal yang lebih penting.
                        </p>
                        <div class="mt-4 pt-3 text-center">
                            <a href="javascript:;" class="btn btn-lg btn-primary text-white text-sm fw-semibold">
                                Jadwalkan Penjemputanmu
                            </a>
                        </div>
                    </div>
                </div>
